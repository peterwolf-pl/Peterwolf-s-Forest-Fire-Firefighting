...
Matches the staged plan from the design document.

| Stage | Focus | 1.0.0 status |
|-------|--------|--------------|
| 1 Foundation | Fabric setup, config, networking, incident manager | Done |
| 2 Fire simulation | staged burn, heat, moisture, wind, smoke, reignition | Done (core) |
| 3 Water system | pump, intake, hose, nozzle, pressure, cooling | Done (core) |
| 4 Firefighter gameplay | gear, tools, firebreaks, backpack, scanner | Done (core) |
